public class Task1Test {
    public static void main ( String[] args) {
        ...
        list.addPatient(new Patient(1 , "Leyla Parlak" , 8 , 18));
        list.addPatient(new Patient(1 , "Tahir Aslan" , 3 , 25));
        list.addPatient(new Patient(1 , "Mehtap Ece Şafak" , 6 , 45));
        list.addPatient(new Patient(1 , "Hakan Çavuş" , 9 , 60));
